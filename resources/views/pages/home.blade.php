...
@section('content')
<div class="wrapper bgded overlay" style="background-image:url('http://localhost/blog1/resources/images/backgrounds/01.png');">
  ...
  <main class="hoc container clear"> 
    ...
    <section>
      ...
      <ul class="nospace group overview">
        <li class="one_third">
          <figure><a href="#"><img src="http://localhost/blog1/resources/images/320x240.png" alt=""></a>
            <figcaption>
...
<div class="wrapper row2">
  <figure class="hoc container clear clients"> 
    ...
    <ul class="nospace group">
      <li class="one_quarter first"><a href="#"><img src="http://localhost/blog1/resources/images/222x100.png" alt=""></a></li>
      <li class="one_quarter"><a href="#"><img src="http://localhost/blog1/resources/images/222x100.png" alt=""></a></li>
      <li class="one_quarter"><a href="#"><img src="http://localhost/blog1/resources/images/222x100.png" alt=""></a></li>
      <li class="one_quarter"><a href="#"><img src="http://localhost/blog1/resources/images/222x100.png" alt=""></a></li>
    </ul>
